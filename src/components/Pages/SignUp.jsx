                ...
                <form onSubmit={handleSubmit} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-1 text-sm">
                        <div className='relative'>
                            <input type="password" name="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-200 dark:text-gray-900 focus:dark:border-lime-400 " required />
                            <FaEyeSlash className='absolute right-2 top-4 text-lime-700'></FaEyeSlash>
                        </div>
                        <div className='relative'>
